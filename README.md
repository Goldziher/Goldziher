...
### API Frameworks
- **[Spikard](https://github.com/Goldziher/spikard)**: High performance polyglot web framework written in Rust. Docs at https://spikard.dev
- **[Litestar](https://github.com/litestar-org/litestar)**: "mid-stack" Python API framework. Docs at https://litestar.dev
...
- **[HTML to Markdown](https://github.com/Goldziher/html-to-markdown)**: High performance Rust HTML to Markdown converter with bindings for Python, TypeScript, Ruby and PHP.
- **[Kreuzberg](https://github.com/Goldziher/kreuzberg)**: High performance document intelligence framework. Docs at https://kreuzberg.dev
...
## Broken Dreams (failed startups and products)
...
- You can find me on the [Kreuzberg Discord Server](https://discord.gg/D5ZR83W5KM).
